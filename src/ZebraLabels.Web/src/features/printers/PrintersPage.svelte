	...
	<div class="panel">
		...
		<div class="grid">
			...
			<div class="grid three">
				...
				<label><input type="checkbox" bind:checked={draft.allowFallback} /> Allow EPL→ZPL fallback</label>
			</div>
			<div class="grid three">
				<label>
					Width (mm)
		...
		<div class="list">
			{#each profiles as profile (profile.id)}
				<div class="card">
					...
					<p class="muted">
						Capabilities: {profile.capabilities.supportsEpl ? 'EPL' : ''} {profile.capabilities.supportsZpl ? 'ZPL' : ''}
					</p>
					<p>{profile.notes}</p>
				</div>
			{/each}
